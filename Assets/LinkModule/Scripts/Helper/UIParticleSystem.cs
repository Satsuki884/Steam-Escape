    ...
    public class UIParticleSystem : MaskableGraphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                else
                {
                    ...
                    {
                        // get particle properties
                        Vector3 pos3d = (_mainModule.simulationSpace == ParticleSystemSimulationSpace.Local
                            ? particle.position
        ...
        private void Update()
        {
            if (!fixedTime && Application.isPlaying)
            {
                ...
                if ((_currentMaterial is not null && _currentTexture != _currentMaterial.mainTexture) ||
                    (material is not null && _currentMaterial is not null && material.shader != _currentMaterial.shader))
                {
                    _pSystem = null;
                    Initialize();
                }
